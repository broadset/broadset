...
- **Modular Files:** Do not write massive 500-line files. Separate interfaces/types, utility functions, Zustand stores, and React components into their own cleanly named files (e.g., `types.ts`, `store.ts`, `EditorCanvas.tsx`).
