...
- [main-integration-plan.md](./main-integration-plan.md)
...
- [plan-progress.md](./plan-progress.md) owns task-by-task execution status
  using **release / functional / scaffold / open / deferred** tiers reconciled
  against code (not legacy checkboxes).
