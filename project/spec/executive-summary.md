...
> This summary is derived from the behavioral specs in this `spec/`
> tree and the structural manifest in `../implementation/architecture.md`. Every statement traces
