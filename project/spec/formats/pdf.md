...
- **P6.6 — chain round-trip + UI wiring.** [`chain-round-trip.test.ts`](../../../packages/formats/src/pdf/v1/import.test.ts); demo `formatBridge.ts`; format modals via io-prereqs Phase 5 slice.
