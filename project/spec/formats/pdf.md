...
- [ ] **Animated Element Static Export:** No automated tests verify that animated elements are exported at t=0 rest state or that active state modifiers are stripped during PDF export.
