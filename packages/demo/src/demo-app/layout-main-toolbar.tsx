...
function FileMenuItems(props: DemoAppLayoutProps): React.JSX.Element {
  const {
    canvasSettings,
    editorState,
...
function ViewMenuUnitItems(props: DemoAppLayoutProps): React.JSX.Element | null {
  const { canvasSettings, editorStore } = props;
...
function ViewMenuViewModeItems(props: DemoAppLayoutProps): React.JSX.Element | null {
  const { canvasSettings, editorStore } = props;
...
function ViewMenuItems(props: DemoAppLayoutProps): React.JSX.Element {
  const { canvasSettings, editorState, editorStore, handleResetZoom, handleZoomToFit, setActiveDialog } = props;
  ...
  return (
    <>
      ...
      <ViewMenuUnitItems {...props} />
      <ViewMenuViewModeItems {...props} />
      <Dropdown.Item
        key="grid-size"
        onAction={() => {
          setActiveDialog('settings');
...
function ScenesMenuItems(props: DemoAppLayoutProps): React.JSX.Element {
  const { currentDocument, editorState, editorStore, pushToast } = props;
...
function HelpMenuItems(props: DemoAppLayoutProps): React.JSX.Element {
