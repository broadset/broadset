...
export function DemoApp(): React.JSX.Element {
  ...
  const stopAnimationTimelinePreview = animationEditing.onStopTimeline;
  ...
  useEffect(() => {
    ...
    stopAnimationTimelinePreview();
    setEditingTimeline(null);
    setEditingTimelineSelectedKf(null);
  }, [isExperimental, stopAnimationTimelinePreview]);

  const handleSidebarTabToggleWithAnimationBoundary = useCallback(
    (nextTab: SidebarTab): void => {
      if (nextTab === 'properties') {
        stopAnimationTimelinePreview();
      }

      handleSidebarTabToggle(nextTab);
    },
    [handleSidebarTabToggle, stopAnimationTimelinePreview],
  );
  ...
  const sidebarPanel = useMemo(
    ...
    [
      ...
      animationEditing.currentTimeMs,
      animationEditing.isTimelinePlaying,
  ...
  useEffect(() => {
    if (editingTimeline !== null && isPlaying) {
      handleResetPlayback();
    }
  }, [editingTimeline, handleResetPlayback, isPlaying]);
  ...
  return (
    <DemoAppLayout
      ...
      handleSidebarTabToggle={handleSidebarTabToggleWithAnimationBoundary}
      ...
      runtimeOverlay={animationEditing.runtimeOverlay}
