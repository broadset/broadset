...
export function DemoSidebarPanel({
  ...
  const selectedKeyframe =
    editingTimelineSelectedKf === null ? undefined : editingTimeline?.keyframes[editingTimelineSelectedKf];
  const selectedKeyframeTargetName =
    selectedKeyframe?.target === undefined ?
      undefined
    : (layers.find((layer) => layer.id === selectedKeyframe.target)?.name ?? selectedKeyframe.target);
    ...
    return (
      <>
        <AnimationSidebar
          ...
          editingTimelineId={editingTimeline?.id}
          isTimelinePreviewPlaying={isTimelinePreviewPlaying}
          timelinePreviewCurrentTimeMs={timelinePreviewCurrentTimeMs}
        ...
        {keyframeAdapter !== null && panelElement !== null && (
          <AnimationModePropertiesPanel
            ...
            keyframeTargetName={selectedKeyframeTargetName}
          />
        )}
      </>
    );
