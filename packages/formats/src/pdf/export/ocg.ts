...
import { type PDFContext, PDFDict, type PDFDocument, PDFName, type PDFPage, type PDFRef, PDFString } from 'pdf-lib';
 ...
 */
export function attachOcgResourceBindings(pdf: PDFDocument, page: PDFPage, registration: OcgRegistration): void {
  ...
  for (const binding of ocgResourceBindings(registration.bindingByElementId)) {
...
function ocgResourceBindings(bindings: ReadonlyMap<string, OcgResourceBinding>): readonly OcgResourceBinding[] {
