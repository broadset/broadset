 ...
 * directly out of the XMP packet when present. Per-layer `BsPs`
 * `additionalInfo` tags are the secondary carrier; import hydrates
 * `extensions.psd.roundTrip` from XMP today — export-side `BsPs`
 * write is tracked in `project/spec/formats/psd.md` §Spec Gaps.
 */
