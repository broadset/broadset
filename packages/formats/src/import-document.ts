 ...
 */
export async function importPptxDocument(data: Uint8Array, options?: PptxImportOptions): Promise<DocumentImportResult> {
  ...
  const reconciliation = await reconcilePptx(data, options);
 ...
 * field null.
 */
export async function importPsdDocument(data: Uint8Array, options?: PsdImportOptions): Promise<DocumentImportResult> {
