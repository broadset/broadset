...
export function ColorInput({
  ...
  const handleTextBlur = useCallback(() => {
    ...
    setIsDrafting(false);
  }, [disabled, isDrafting, draft, onChange, allowAlpha]);
          ...
          <Popover.Content>
            <Popover.Dialog>
              ...
              >
                ...
                <Select aria-label="Color format" isDisabled={disabled} value={format} onChange={handleFormatChange}>
                  <Select.Trigger>
                    <Select.Value />
                    <Select.Indicator />
                  </Select.Trigger>
                ...
                <div data-testid="palette" style={{ display: 'flex', flexDirection: 'column', gap: sp('sp-02') }}>
                  ...
                  <Button aria-label="Add to palette" isDisabled={disabled} onPress={handleAddPalette}>
                    Add
                  </Button>
                </div>
              </div>
