import type { BooleanOperation, TemplateGroup, TemplateGroupRole, VerticalAlignment } from '@broadset/model';
...
const TEMPLATE_GROUP_ROLE_OPTIONS = ['16:9', '9:16', '1:1', '4:3', 'custom'] as const;
